...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/customer_listcondition" method=post>
											...
											<TBODY>
												...
												<c:forEach items="${list }" var="customer">
													<TR
														...
														<TD><a href="${pageContext.request.contextPath }/customer_toUpdate?cid=${customer.cid}">修改</a>
															&nbsp;&nbsp; 
												...
												<%-- <s:iterator value="list" var="customer">
													<TR
														...
														<TD><a href="${pageContext.request.contextPath }/customer_toUpdate?cid=<s:property value="#customer.cid"/>">修改</a>
															&nbsp;&nbsp; 
															<a href="${pageContext.request.contextPath }/customer_delete?cid=<s:property value="#customer.cid"/>">删除</a>
														</TD>
													</TR>
