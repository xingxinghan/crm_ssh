...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/customer_listpage" method=post>
											...
											<TBODY>
												...
												<c:forEach items="${pageBean.list }" var="customer">
													<TR
														...
														<TD><a href="${pageContext.request.contextPath }/customer_toUpdate?custId=${customer.cid}">修改</a>
															&nbsp;&nbsp; 
															<a href="${pageContext.request.contextPath }/customer_delete?custId=${customer.cid}">删除</a>
														</TD>
													</TR>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B>${pageBean.totalCount}</B>]条记录,共有[<B>${pageBean.totalPage}</B>]页，当前为第[<B>${pageBean.currentPage}</B>]页，
