									...
									<TABLE id=grid
										...
										<c:forEach items="${linkMans }" var="linkman">
											<TR
												...
												<TD><a
													href="${pageContext.request.contextPath }/linkman_toUpdatePage?lid=${linkman.lid}">修改</a>
													&nbsp;&nbsp; <a
													href="${pageContext.request.contextPath }/linkman_delete?lid=${linkman.lid}">删除</a>
												</TD>
											</TR>
